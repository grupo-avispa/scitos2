...
class ScitosDrive : public ScitosModule{
	...
	private:
		rclcpp_lifecycle::LifecyclePublisher<scitos2_msgs::msg::BumperStatus>::SharedPtr bumper_pub_;
		rclcpp_lifecycle::LifecyclePublisher<visualization_msgs::msg::MarkerArray>::SharedPtr bumper_markers_pub_;
		rclcpp_lifecycle::LifecyclePublisher<scitos2_msgs::msg::DriveStatus>::SharedPtr drive_status_pub_;
		rclcpp_lifecycle::LifecyclePublisher<scitos2_msgs::msg::EmergencyStopStatus>::SharedPtr emergency_stop_pub_;
		rclcpp_lifecycle::LifecyclePublisher<scitos2_msgs::msg::BarrierStatus>::SharedPtr magnetic_barrier_pub_;
		rclcpp_lifecycle::LifecyclePublisher<scitos2_msgs::msg::Mileage>::SharedPtr mileage_pub_;
		rclcpp_lifecycle::LifecyclePublisher<nav_msgs::msg::Odometry>::SharedPtr odometry_pub_;
		rclcpp_lifecycle::LifecyclePublisher<scitos2_msgs::msg::RfidTag>::SharedPtr rfid_pub_;
			
		rclcpp::Subscription<geometry_msgs::msg::Twist>::SharedPtr cmd_vel_sub_;

		rclcpp::Service<scitos2_msgs::srv::ChangeForce>::SharedPtr change_force_service_;
		rclcpp::Service<scitos2_msgs::srv::EmergencyStop>::SharedPtr emergency_stop_service_;
		rclcpp::Service<scitos2_msgs::srv::EnableMotors>::SharedPtr enable_motors_service_;
		rclcpp::Service<scitos2_msgs::srv::EnableRfid>::SharedPtr enable_rfid_service_;
		rclcpp::Service<scitos2_msgs::srv::ResetBarrierStop>::SharedPtr reset_barrier_stop_service_;
		rclcpp::Service<scitos2_msgs::srv::ResetMotorStop>::SharedPtr reset_motor_stop_service_;
		rclcpp::Service<scitos2_msgs::srv::ResetOdometry>::SharedPtr reset_odometry_service_;
		rclcpp::Service<scitos2_msgs::srv::SuspendBumper>::SharedPtr suspend_bumper_service_;
